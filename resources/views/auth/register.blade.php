<x-guest-layout>
    ...
    <div class="mb-6 text-center">
        <h1 class="text-2xl font-bold text-gray-800">Bun venit la Texora</h1>
        <p class="text-sm text-gray-500">Creează-ți contul și începe să îți gestionezi afacerea</p>
    </div>
